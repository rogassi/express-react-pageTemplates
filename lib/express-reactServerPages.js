                    ...
                    for (var pos in templateAr) {
                        ...
                        if (myArray[1] == "REACT") {
                            ...
                            switch (myArray[4].toUpperCase()) {
                                case "TITLE":
                                    if (_template.renderTitle != null) {
                                        component = _template.renderTitle(myArray[4], mergedContext);
                                        if (component != null) {
                                    ...
                                    break;
                                case "DESCRIPTION":
                                    if (_template.renderDescription != null) {
                                        component = _template.renderDescription(myArray[4], mergedContext);
                                        if (component != null) {
                                            component = "<meta name=\"description\" content=\"" + component + "\">";
                                        }
                                    }
                                    ...
                                    break;
                                case "KEYWORDS":
                                    if (_template.renderKeywords != null) {
                                        component = _template.renderKeywords(myArray[4], mergedContext);
                                        if (component != null) {
                                            component = "<meta name=\"keywords\" content=\"" + component + "\">";
                                        }
                                    }
                            ...
                            if (_template.renderOpenGraph != null) {
                                component = _template.renderOpenGraph(myArray[4].toLowerCase(), mergedContext);
                                if (component != null) {
                                    component = "<meta property=\"og:" + myArray[4].toLowerCase() + "\" content=\"" + component + "\" />";
                                }
                            }
...
ExpressReactServerPages.prototype._getTemplateArray = function (filePath, options) {
    ...
    const rex = /<(REACT).*"(.*)".*\/>|<(SEO|OG).*"(.*)".*\/>|<((?:title|TITLE)+).*>(.*)<\/.*(?:title|TITLE)>|\{\{(BUILDID)\}\}/gm;
