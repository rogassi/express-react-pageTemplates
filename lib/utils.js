...
function buildTag(tagClass, tagName, seo, context) {
    ...
    <meta rel="canonical" href="` + languageTagValue + `" />`

                            context.i18n.options.supportedLanguages.forEach(element => {

                                if (context.i18n.language != element)
                                    component = component + '\r\n' + `    <meta rel="alternate" href="` + tagValue.replace('{{CURRENTLANG}}', element) + `" hreflang="` + element + `" />`;

                            });
                            component = component + '\r\n' + `    <meta rel="alternate" href="` + tagValue.replace('/{{CURRENTLANG}}', '') + `" hreflang="x-default" />`;
    ...
    <meta rel="canonical" href="` + tagValue + `" />`;
                        break;
